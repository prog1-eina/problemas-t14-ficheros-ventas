 ...
 *       Code.
 *       También puede compilarse desde la terminal con la orden:
 *           g++ -Wall -Wextra problemas-ventas.cpp -o problemas-ventas
 *       y ejecutarse en Windows con:
 *           .\problemas-ventas.exe
 *       o en Linux y macOS con:
 *           ./problemas-ventas
 *****************************************************************************/
 ...
 *       sintaxis de los ficheros de ventas indicada en el enunciado y está
 *       listo para leer desde el inicio de una línea.
 * Post: Intenta leer la línea mencionada en la precondición y, si no se
 *       terminan los datos del fichero, almacena en los campos del parámetro
 *       «venta» el código del producto, el código del cliente, la cantidad
 *       y el precio unitario leídos. Devuelve «true» si se han podido leer
 *       los datos; devuelve «false» en caso contrario.
 */
 ...
 * Post: Devuelve la cantidad total a facturar al cliente cuyo código es igual
 ...
 * Post: Escribe una línea en el flujo «f» con los campos del parámetro
 *       «venta»: código del producto, código del cliente, cantidad y precio
 *       unitario, siguiendo la sintaxis de la regla <venta> indicada en el
 *       enunciado.
 */
 ...
 *       <fichero-ventas>. Es posible crear o reescribir el fichero de nombre
 *       «nombreFicheroFinal» para su escritura.
 * Post: Copia en el fichero «nombreFicheroFinal» las ventas del fichero
 *       «nombreFicheroOriginal» que no son erróneas y solo esas. Una venta
 *       es errónea cuando la cantidad o el precio unitario NO son positivos.
 */
 ...
 *       registradas en el fichero de ventas de nombre «nombreFichero». Si el
 *       fichero no se puede abrir, devuelve -1.
 */
 ...
 * Pre:  Existe un fichero de ventas con el nombre «nombreFichero» accesible
 *       para su lectura y que cumple con la sintaxis de la regla
 *       <fichero-ventas>. El número de ventas almacenadas en el fichero es
 *       menor o igual a la dimensión del vector «ventas».
 * Post: Si el fichero «nombreFichero» se ha podido abrir, asigna a «nVentas»
 *       el número de ventas del fichero, almacena en las primeras «nVentas»
 *       componentes del vector «ventas» la información de las ventas
 *       almacenadas en el fichero y asigna a «lecturaOk» el valor «true».
 *       En caso contrario, asigna a «lecturaOk» el valor «false».
 */
...
/* Pre:  ---
 * Post: Crea un fichero llamado «nombreFichero» y almacena la información de
 *       las «n» primeras componentes del vector «ventas» siguiendo la sintaxis
 *       de los ficheros de ventas indicada en el enunciado. Si el fichero se
 *       ha creado correctamente, asigna «true» a «escrituraOk». En caso
 *       contrario, asigna «false» a «escrituraOk».
 */
...
/*
 * Programa que prueba las funciones «totalFactura» y «numClientesDistintos».
 * Debe escribir «true» en la pantalla un total de 5 veces.
 */
int main() {
    cout << boolalpha;
